 ...
 */
public class AuthAuthenticationRouter implements SsoAuthenticationRouter {

    private static final Logger LOGGER = LoggerFactory.getLogger(AuthAuthenticationRouter.class);
