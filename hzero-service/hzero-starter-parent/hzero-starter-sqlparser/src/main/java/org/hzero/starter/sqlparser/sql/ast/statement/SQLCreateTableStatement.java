...
import org.hzero.starter.sqlparser.util.ListDG;
import org.hzero.starter.sqlparser.util.lang.Consumer;
...
public class SQLCreateTableStatement extends SQLStatementImpl implements SQLDDLStatement, SQLCreateStatement {
    ...
    public void simplify() {
        ...
        if (name instanceof SQLPropertyExpr) {
            ...
            if (!Objects.equals(tableName, normalized)) {
        ...
        if (name instanceof SQLIdentifierExpr) {
            ...
            String normalized = SQLUtils.normalize(tableName, dbType);
            if (!Objects.equals(normalized, tableName)) {
                setName(normalized);
            }
        }
