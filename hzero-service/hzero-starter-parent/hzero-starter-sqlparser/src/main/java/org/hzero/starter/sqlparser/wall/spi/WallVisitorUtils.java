...
import org.hzero.starter.sqlparser.sql.ast.expr.SQLCaseExpr.Item;
...
import org.hzero.starter.sqlparser.sql.ast.statement.SQLAlterStatement;
...
import org.hzero.starter.sqlparser.sql.ast.statement.SQLCreateStatement;
...
import org.hzero.starter.sqlparser.sql.ast.statement.SQLDropStatement;
...
import org.hzero.starter.sqlparser.sql.ast.statement.SQLUnionOperator;
...
import org.hzero.starter.sqlparser.sql.dialect.mysql.ast.statement.MySqlShowStatement;
...
import org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitor;
import org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitorUtils;
import org.hzero.starter.sqlparser.sql.visitor.functions.Nil;
...
import org.hzero.starter.sqlparser.util.ServletPathMatcher;
import org.hzero.starter.sqlparser.util.StringUtils;
import org.hzero.starter.sqlparser.wall.WallConfig;
import org.hzero.starter.sqlparser.wall.WallConfig.TenantCallBack;
import org.hzero.starter.sqlparser.wall.WallConfig.TenantCallBack.StatementType;
import org.hzero.starter.sqlparser.wall.WallContext;
import org.hzero.starter.sqlparser.wall.WallProvider;
import org.hzero.starter.sqlparser.wall.WallSqlTableStat;
import org.hzero.starter.sqlparser.wall.WallUpdateCheckHandler;
...
public class WallVisitorUtils {
    ...
    private final static String[] whiteHints    = { "LOCAL", "TEMPORARY", "SQL_NO_CACHE", "SQL_CACHE", "HIGH_PRIORITY",
    ...
    private static Object getValue_and(WallVisitor visitor, List<SQLExpr> groupList) {
        ...
        for (int i = groupList.size() - 1; i >= 0; --i) {
            ...
            if (Boolean.TRUE.equals(booleanVal)) {
                ...
                if (!Objects.equals(allTrue, Boolean.FALSE)) {
                    allTrue = null;
                }
                dalConst = 0;
            }
