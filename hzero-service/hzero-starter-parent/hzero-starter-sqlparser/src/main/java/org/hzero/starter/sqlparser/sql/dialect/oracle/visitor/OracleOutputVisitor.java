...
import org.hzero.starter.sqlparser.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
...
import org.hzero.starter.sqlparser.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
...
import org.hzero.starter.sqlparser.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
...
import org.hzero.starter.sqlparser.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
...
import org.hzero.starter.sqlparser.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
...
public class OracleOutputVisitor extends SQLASTOutputVisitor implements OracleASTVisitor {
    ...
    public boolean visit(OracleSelectJoin x) {
        ...
        if (x.getJoinType() == JoinType.COMMA) {
            ...
            println();
            print0(ucase ? x.getJoinType().value : x.getJoinType().name_lcase);
            print(' ');
