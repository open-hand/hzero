...
//        }
    ...
    public boolean visit(OracleCreateTableStatement x) {
        ...
        if (Objects.equals(x.getParallel(), Boolean.TRUE)) {
            println();
            print0(ucase ? "PARALLEL" : "parallel");
        } else if (Objects.equals(x.getParallel(), Boolean.FALSE)) {
            println();
            print0(ucase ? "NOPARALLEL" : "noparallel");
        }

        if (Objects.equals(x.getCache(), Boolean.TRUE)) {
            println();
            print0(ucase ? "CACHE" : "cache");
        } else if (Objects.equals(x.getCache(), Boolean.FALSE)) {
            println();
    ...
    public boolean visit(OracleIsOfTypeExpr x) {
        ...
        for (int i = 0, size = types.size(); i < size; ++i) {
            ...
            if (Objects.equals(Boolean.TRUE, type.getAttribute("ONLY"))) {
                print0(ucase ? "ONLY " : "only ");
            }
            type.accept(this);
        }
