...
import org.hzero.starter.sqlparser.wall.spi.WallVisitorUtils.WallTopStatementContext;
...
public class MySqlWallVisitor extends MySqlASTVisitorAdapter implements WallVisitor, MySqlASTVisitor {
    ...
    public boolean visit(SQLPropertyExpr x) {
        ...
        boolean flag = varName.equalsIgnoreCase("@@session") || varName.equalsIgnoreCase("@@global");
        if (!flag) {
            WallVisitorUtils.check(this, x);
            return true;
        }
