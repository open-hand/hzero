...
import static org.hzero.starter.sqlparser.sql.parser.CharTypes.isFirstIdentifierChar;
import static org.hzero.starter.sqlparser.sql.parser.CharTypes.isIdentifierChar;
import static org.hzero.starter.sqlparser.sql.parser.CharTypes.isWhitespace;
import static org.hzero.starter.sqlparser.sql.parser.LayoutCharacters.EOI;
import static org.hzero.starter.sqlparser.sql.parser.SQLParserFeature.KeepComments;
import static org.hzero.starter.sqlparser.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static org.hzero.starter.sqlparser.sql.parser.SQLParserFeature.SkipComments;
import static org.hzero.starter.sqlparser.sql.parser.Token.COLONCOLON;
import static org.hzero.starter.sqlparser.sql.parser.Token.COLONEQ;
import static org.hzero.starter.sqlparser.sql.parser.Token.COMMA;
import static org.hzero.starter.sqlparser.sql.parser.Token.DOT;
import static org.hzero.starter.sqlparser.sql.parser.Token.EOF;
import static org.hzero.starter.sqlparser.sql.parser.Token.EQ;
import static org.hzero.starter.sqlparser.sql.parser.Token.ERROR;
import static org.hzero.starter.sqlparser.sql.parser.Token.LBRACE;
import static org.hzero.starter.sqlparser.sql.parser.Token.LBRACKET;
import static org.hzero.starter.sqlparser.sql.parser.Token.LITERAL_ALIAS;
import static org.hzero.starter.sqlparser.sql.parser.Token.LITERAL_CHARS;
import static org.hzero.starter.sqlparser.sql.parser.Token.LPAREN;
import static org.hzero.starter.sqlparser.sql.parser.Token.RBRACE;
import static org.hzero.starter.sqlparser.sql.parser.Token.RBRACKET;
import static org.hzero.starter.sqlparser.sql.parser.Token.RPAREN;

/**
 * @author wenshao [szujobs@hotmail.com]
 */
public class Lexer {
    protected static final SymbolTable symbols_l2 = new SymbolTable(512);
