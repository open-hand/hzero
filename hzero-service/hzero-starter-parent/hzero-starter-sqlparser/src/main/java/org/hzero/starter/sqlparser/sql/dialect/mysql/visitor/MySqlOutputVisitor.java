...
import org.hzero.starter.sqlparser.sql.ast.statement.SQLColumnConstraint;
...
import org.hzero.starter.sqlparser.sql.dialect.mysql.ast.statement.MySqlCreateTableStatement.TableSpaceOption;
import org.hzero.starter.sqlparser.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement;
import org.hzero.starter.sqlparser.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement.UserSpecification;
...
import org.hzero.starter.sqlparser.sql.visitor.VisitorFeature;
...
public class MySqlOutputVisitor extends SQLASTOutputVisitor implements MySqlASTVisitor {
    ...
    public boolean visit(MySqlMatchAgainstExpr x) {
        ...
        if (x.getSearchModifier() != null) {
            print(' ');
            print0(ucase ? x.getSearchModifier().value : x.getSearchModifier().name_lcase);
        }
        print(')');
...
//    }
    ...
    public boolean visit(MySqlIgnoreIndexHint x) {
        ...
        if (x.getOption() != null) {
            print0(ucase ? "FOR " : "for ");
            print0(ucase ? x.getOption().value : x.getOption().name_lcase);
            print(' ');
        }
        print('(');
        printAndAccept(x.getIndexList(), ", ");
    ...
    public boolean visit(MySqlOrderingExpr x) {
        ...
        if (x.getType() != null) {
            print(' ');
            print0(ucase ? x.getType().orderName : x.getType().name_lcase);
        }
