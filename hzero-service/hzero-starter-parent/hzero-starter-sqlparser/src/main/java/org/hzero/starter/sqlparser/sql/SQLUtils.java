 ...
 */
package org.hzero.starter.sqlparser.sql;
...
import org.hzero.starter.sqlparser.sql.ast.SQLReplaceable;
...
import org.hzero.starter.sqlparser.sql.dialect.db2.visitor.DB2OutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.db2.visitor.DB2SchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.h2.visitor.H2OutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.h2.visitor.H2SchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.hive.visitor.HiveOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.hive.visitor.HiveSchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.mysql.visitor.MySqlOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.mysql.visitor.MySqlSchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.odps.visitor.OdpsOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.odps.visitor.OdpsSchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.oracle.visitor.OracleOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.oracle.visitor.OracleSchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.oracle.visitor.OracleToMySqlOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.postgresql.visitor.PGOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.postgresql.visitor.PGSchemaStatVisitor;
import org.hzero.starter.sqlparser.sql.dialect.sqlserver.visitor.SQLServerOutputVisitor;
import org.hzero.starter.sqlparser.sql.dialect.sqlserver.visitor.SQLServerSchemaStatVisitor;
...
import org.hzero.starter.sqlparser.sql.parser.SQLParserUtils;
...
import org.hzero.starter.sqlparser.util.MySqlUtils;
import org.hzero.starter.sqlparser.util.OracleUtils;
import org.hzero.starter.sqlparser.util.PGUtils;
...
public class SQLUtils {
    ...
    public static final FormatOption DEFAULT_FORMAT_OPTION = new FormatOption(true, true);
    public static final FormatOption DEFAULT_LCASE_FORMAT_OPTION
