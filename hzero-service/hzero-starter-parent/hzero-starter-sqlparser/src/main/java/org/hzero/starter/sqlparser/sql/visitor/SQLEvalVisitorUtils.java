...
import org.hzero.starter.sqlparser.DruidRuntimeException;
...
import org.hzero.starter.sqlparser.sql.ast.expr.SQLUnaryOperator;
import org.hzero.starter.sqlparser.sql.ast.expr.SQLValuableExpr;
...
import org.hzero.starter.sqlparser.sql.dialect.db2.visitor.DB2EvalVisitor;
import org.hzero.starter.sqlparser.sql.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import org.hzero.starter.sqlparser.sql.dialect.oracle.visitor.OracleEvalVisitor;
import org.hzero.starter.sqlparser.sql.dialect.postgresql.visitor.PGEvalVisitor;
import org.hzero.starter.sqlparser.sql.dialect.sqlserver.visitor.SQLServerEvalVisitor;
import org.hzero.starter.sqlparser.sql.visitor.functions.Ascii;
import org.hzero.starter.sqlparser.sql.visitor.functions.Bin;
import org.hzero.starter.sqlparser.sql.visitor.functions.BitLength;
import org.hzero.starter.sqlparser.sql.visitor.functions.Char;
import org.hzero.starter.sqlparser.sql.visitor.functions.Concat;
import org.hzero.starter.sqlparser.sql.visitor.functions.Elt;
import org.hzero.starter.sqlparser.sql.visitor.functions.Function;
import org.hzero.starter.sqlparser.sql.visitor.functions.Greatest;
import org.hzero.starter.sqlparser.sql.visitor.functions.Hex;
import org.hzero.starter.sqlparser.sql.visitor.functions.If;
import org.hzero.starter.sqlparser.sql.visitor.functions.Insert;
import org.hzero.starter.sqlparser.sql.visitor.functions.Instr;
import org.hzero.starter.sqlparser.sql.visitor.functions.Isnull;
import org.hzero.starter.sqlparser.sql.visitor.functions.Lcase;
import org.hzero.starter.sqlparser.sql.visitor.functions.Least;
import org.hzero.starter.sqlparser.sql.visitor.functions.Left;
import org.hzero.starter.sqlparser.sql.visitor.functions.Length;
import org.hzero.starter.sqlparser.sql.visitor.functions.Locate;
import org.hzero.starter.sqlparser.sql.visitor.functions.Lpad;
import org.hzero.starter.sqlparser.sql.visitor.functions.Ltrim;
import org.hzero.starter.sqlparser.sql.visitor.functions.Now;
import org.hzero.starter.sqlparser.sql.visitor.functions.OneParamFunctions;
import org.hzero.starter.sqlparser.sql.visitor.functions.Reverse;
import org.hzero.starter.sqlparser.sql.visitor.functions.Right;
import org.hzero.starter.sqlparser.sql.visitor.functions.Substring;
import org.hzero.starter.sqlparser.sql.visitor.functions.Trim;
import org.hzero.starter.sqlparser.sql.visitor.functions.Ucase;
import org.hzero.starter.sqlparser.sql.visitor.functions.Unhex;
import org.hzero.starter.sqlparser.util.HexBin;
import org.hzero.starter.sqlparser.util.JdbcConstants;
import org.hzero.starter.sqlparser.util.JdbcUtils;
import org.hzero.starter.sqlparser.util.Utils;
import org.hzero.starter.sqlparser.wall.spi.WallVisitorUtils;
import org.hzero.starter.sqlparser.wall.spi.WallVisitorUtils.WallConditionContext;
...
import static org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitor.EVAL_ERROR;
import static org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitor.EVAL_EXPR;
import static org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitor.EVAL_VALUE;
import static org.hzero.starter.sqlparser.sql.visitor.SQLEvalVisitor.EVAL_VALUE_NULL;
    ...
    public static boolean visit(SQLEvalVisitor visitor, SQLCaseExpr x) {
        ...
        for (SQLCaseExpr.Item item : x.getItems()) {
            ...
            if ((x.getValueExpr() != null && eq(value, conditionValue))
                || (x.getValueExpr() == null && Objects.equals(conditionValue, Boolean.TRUE))) {
