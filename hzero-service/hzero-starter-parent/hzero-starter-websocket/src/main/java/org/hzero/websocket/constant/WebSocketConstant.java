...
public class WebSocketConstant {
    ...
    public static final class Attributes {
         ...
         * token
         */
        public static final String TOKEN = TokenConstants.ACCESS_TOKEN;
        public static final String[] TOKENS = TokenConstants.ACCESS_TOKENS;
        public static final String SECRET_KEY = "secret_key";
        public static final String[] SECRET_KEYS = new String[]{"r3b1i7", SECRET_KEY};
        public static final String GROUP = "group";
        public static final String PROCESSOR = "processor";
        public static final String ENCRYPTED_TOKEN = "token";
        public static final String[] ENCRYPTED_TOKENS = new String[]{"j5a4p9", ENCRYPTED_TOKEN};
    }
