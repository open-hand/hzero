...
public class SqlserverKeywordChecker implements KeywordChecker {
    ...
    static {
        keywordSet = Arrays.stream(SqlserverKeywordChecker.SqlserverKeyword.values()).map(SqlserverKeywordChecker.SqlserverKeyword::getKeywordName).collect(Collectors.toSet());
    }
