 ...
 */
@Api(tags = MessageSwaggerApiConfig.TEMPLATE_SERVER_WH)
@RestController("templateServerWhController.v1")
@RequestMapping("/v1/{organizationId}/template-server-whs/{tempServerLineId}")
public class TemplateServerWhController extends BaseController {
    ...
    @GetMapping
    public ResponseEntity<Page<TemplateServerWh>> pageTemplateServerWh(@PathVariable("organizationId") Long tenantId,
    ...
    @Permission(level = ResourceLevel.ORGANIZATION)
    @PostMapping
    public ResponseEntity<List<TemplateServerWh>> create(@PathVariable("organizationId") Long tenantId,
                    @Encrypt @PathVariable("tempServerLineId") Long tempServerLineId,
    ...
    public ResponseEntity remove(@PathVariable("organizationId") Long tenantId,
                    @Encrypt @RequestBody List<TemplateServerWh> templateServerWhs) {
