...
public class LovProperties {
    ...
    public static class Sql {
        ...
        private List<String> dollarParamDenyTokens = Arrays.asList("'", "\"", ";", "--", "/*", "*/");
        private List<String> dollarParamDenyKeywords = Arrays.asList("union", "select", "insert", "update",
                "delete", "drop", "truncate", "alter", "exec", "execute", "call", "declare");
        ...
        public List<String> getDollarParamDenyTokens() {
            return dollarParamDenyTokens;
        }

        public void setDollarParamDenyTokens(List<String> dollarParamDenyTokens) {
            this.dollarParamDenyTokens = dollarParamDenyTokens;
        }

        public List<String> getDollarParamDenyKeywords() {
            return dollarParamDenyKeywords;
        }

        public void setDollarParamDenyKeywords(List<String> dollarParamDenyKeywords) {
            this.dollarParamDenyKeywords = dollarParamDenyKeywords;
        }
    }
