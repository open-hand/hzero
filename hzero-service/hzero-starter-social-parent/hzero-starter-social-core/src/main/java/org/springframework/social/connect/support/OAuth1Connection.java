...
public class OAuth1Connection<A> extends AbstractConnection<A> {
	...
	public ConnectionData createData() {
		synchronized (getMonitor()) {
			return new ConnectionData(getKey().getProviderId(), getKey().getProviderUserId(), getDisplayName(), getProfileUrl(), getImageUrl(), accessToken, secret, null, null, getProviderUnionId());
		}
	}
