 ...
 */
@Api(tags = SwaggerApiConfig.LABEL_RELATION)
@RestController("labelRelController.v1")
@RequestMapping("/v1/{organizationId}/label-rels")
public class LabelRelController extends BaseController {
    ...
    @ApiOperation(value = "根据数据类型和数据ID查询数据相关的可见标签关系详情")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "organizationId", value = "租户ID", required = true, paramType = "path"),
    ...
    public ResponseEntity<List<LabelRel>> listViewDataLabelRel(
