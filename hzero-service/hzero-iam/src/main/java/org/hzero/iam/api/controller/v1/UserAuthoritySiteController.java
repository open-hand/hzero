 ...
 */
@Api(tags = SwaggerApiConfig.USER_AUTHORITY_SITE)
@RestController("userAuthoritySiteController.v1")
@RequestMapping("/v1/users/{userId}")
public class UserAuthoritySiteController extends BaseController {
    ...
    @GetMapping("{organizationId}/authority")
    @CustomPageRequest
    ...
    @Permission(level = ResourceLevel.SITE)
    @PostMapping("{organizationId}/authority")
    ...
    @Permission(level = ResourceLevel.SITE)
    @DeleteMapping("{organizationId}/authority")
    ...
    @Permission(level = ResourceLevel.SITE)
    @PostMapping("{organizationId}/authority/copy")
    ...
    @Permission(level = ResourceLevel.SITE)
    @PostMapping("{organizationId}/authority/exchange")
    ...
    @Permission(level = ResourceLevel.SITE)
    @GetMapping("{organizationId}/authority-org")
    ...
    @Permission(level = ResourceLevel.SITE)
    @PostMapping("{organizationId}/authority-org")
    @ProcessLovValue(targetField = BaseConstants.FIELD_BODY)
    ...
    @Permission(level = ResourceLevel.SITE)
    @GetMapping("{organizationId}/data/purorgs")
    @CustomPageRequest
    ...
    @Permission(level = ResourceLevel.SITE)
    @GetMapping("{organizationId}/data/puragents")
    @CustomPageRequest
    ...
    @Permission(level = ResourceLevel.SITE)
    @GetMapping("{organizationId}/data/purcats")
    @CustomPageRequest
    ...
    @Permission(level = ResourceLevel.SITE)
    @GetMapping("/{organizationId}/data/data-group")
    @CustomPageRequest
