 ...
 * @author xingxing.wu
 */
@Api(tags = SwaggerApiConfig.SEC_GRP_ROLE_ASSIGN)
@RestController("secGrpRoleAssignController.v1")
@RequestMapping("/v1/{organizationId}/sec-grp-role-assign")
public class SecGrpRoleAssignController {
    ...
    public ResponseEntity<Void> roleAssignSecGrp(@PathVariable Long organizationId,
    ...
    public ResponseEntity<Void> roleRecycleSecGrp(@PathVariable("roleId") @Encrypt Long roleId,
                                                  @RequestBody @Encrypt List<Long> secGrpIds) {
    ...
    public ResponseEntity<List<Menu>> listRoleSecGrpAcl(@PathVariable @Encrypt Long roleId,
    ...
    public ResponseEntity<SecGrpDclDTO> listRoleSecGrpDcl(
            @ApiParam(value = "安全组ID") @PathVariable @Encrypt Long secGrpId,
            @ApiParam(value = "角色ID") @PathVariable @Encrypt Long roleId,
            SecGrpDclQueryDTO queryDTO, @ApiIgnore PageRequest pageRequest) {
