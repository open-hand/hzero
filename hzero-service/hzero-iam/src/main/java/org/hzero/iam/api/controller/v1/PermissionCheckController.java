 ...
 */
@Api(tags = SwaggerApiConfig.PERMISSION_CHECK)
@RestController("permissionCheckController.v1")
@RequestMapping("/v1/{organizationId}/permission-check")
public class PermissionCheckController {
    ...
    @GetMapping
    public ResponseEntity<Page<PermissionCheck>> page(@PathVariable Long organizationId, PermissionCheck permissionCheck,
