 ...
 */
@Component
public class LocalPuragentDclService extends AbstractLocalDclService {
    @Override
    public SecGrpDclDTO querySecGrpDclAssignableAuthority(@Nonnull SecGrpDclQueryDTO queryDTO, @Nonnull PageRequest pageRequest) {
        ...
        if (selfDim || this.isSuperAdmin(queryDTO.getRoleId())) {
            ...
            Page<SecGrpDclLine> page = PageHelper.doPageAndSort(pageRequest, () -> secGrpDclLineMapper.selectGlobalAssignablePurAgent(queryDTO));
    ...
    protected String getAuthorityTypeCode() {
        return Constants.DocLocalAuthorityTypeCode.PURAGENT;
    }
}
