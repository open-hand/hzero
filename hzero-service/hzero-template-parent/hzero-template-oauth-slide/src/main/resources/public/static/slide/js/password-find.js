...
$(document).ready(function () {
  ...
  function initInitialData() {
    // storeData.initData.logoSrc = '/oauth/static/slide/img/logo.png'; // logo 地址
            ...
            $.ajax({
              ...
              success: function success(data) {
                if (data.failed == true) {
                  ...
                  if (location.search) {
                    window.location.href = '/oauth/public/slide/password_find.html' + location.search + '&currentStep=1';
                  } else {
                    window.location.href = '/oauth/public/slide/password_find.html?currentStep=1';
                  }
                }
              },
  ...
  function backConfirmAccount() {
    window.location.href = '/oauth/public/slide/password_find.html';
  }
  /**
   * 手机登录 发送验证吗
   */
  ...
  function resetPassword() {
    ...
    $.ajax({
      ...
      success: function success(data) {
        if (data.success) {
          window.location.href = '/oauth/public/slide/password_find.html?currentStep=2';
        } else {
          switch (data.code) {
