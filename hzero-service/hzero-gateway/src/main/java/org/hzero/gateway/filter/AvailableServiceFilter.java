...
public class AvailableServiceFilter implements GlobalFilter, Ordered {
    ...
    private MaintainProperties.MaintainState identifyState(String serviceName) {
        ...
        MaintainProperties.MaintainState serviceState = serviceInfo == null ? MaintainProperties.MaintainState.NORMAL : serviceInfo.getState();
        MaintainProperties.MaintainState globalState = globalInfo == null ? MaintainProperties.MaintainState.NORMAL : globalInfo.getState();
