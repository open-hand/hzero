package org.hzero.gateway.ratelimit.limiter;
 ...
 */
public class EnhancedRedisRateLimiter extends AbstractRateLimiter<EnhancedRedisRateLimiter.Config> implements ApplicationContextAware {
    ...
    public HashMap<String, String> getHeaders(EnhancedRedisRateLimiter.Config config, String id, Long tokensLeft) {
        ...
        headers.put(this.replenishRateHeader, config == null ? String.valueOf(Integer.MAX_VALUE) : String.valueOf(getReplenishRate(config, id)));
        headers.put(this.burstCapacityHeader, config == null ? String.valueOf(Integer.MAX_VALUE) : String.valueOf(getBurstCapacity(config, id)));
        return headers;
    }
    ...
    public static class Config{
         ...
         * value: config {replenishRate, burstCapacity}
         */
