 ...
 */
@Api(tags = PlatformSwaggerApiConfig.DATA_GROUP_LINE_DTL_SITE)
@RestController("dataGroupDtlSiteController.v1")
@RequestMapping("/v1/data-dtls")
public class DataGroupDtlSiteController extends BaseController {
    ...
    public ResponseEntity<Page<DataGroupDtl>> list(@PathVariable("dataLineId")  @Encrypt Long dataLineId,
    ...
    public ResponseEntity<List<DataGroupDtl>> create(@PathVariable("dataLineId") @Encrypt Long dataLineId,
