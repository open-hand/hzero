 ...
 */
@Api(tags = PlatformSwaggerApiConfig.TEMPLATE_CONFIG_SITE)
@RestController("templateConfigSiteController.v1")
@RequestMapping("/v1/template-configs")
public class TemplateConfigSiteController extends BaseController {
    ...
    public ResponseEntity<Page<TemplateConfig>> pageTemplateConfigs(
        ...
        return Results.success(templateConfigRepository.selectTemplateConfigs(
                        templateConfig.setTemplateAssignId(templateAssignId), pageRequest));
    }
