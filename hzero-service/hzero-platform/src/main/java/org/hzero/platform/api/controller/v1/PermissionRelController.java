 ...
 */
@Api(tags = PlatformSwaggerApiConfig.PERMISSION_REL)
@RestController("permissionRelController.v1")
@RequestMapping("/v1/{organizationId}/permission-rel")
public class PermissionRelController extends BaseController {
    ...
    @GetMapping("/{rangeId}")
    public ResponseEntity list(@PathVariable @Encrypt Long rangeId, @PathVariable Long organizationId) {
