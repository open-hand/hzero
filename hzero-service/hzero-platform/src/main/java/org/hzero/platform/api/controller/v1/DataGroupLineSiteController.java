 ...
 */
@Api(tags = PlatformSwaggerApiConfig.DATA_GROUP_LINE_SITE)
@RestController("dataGroupLineSiteController.v1")
@RequestMapping("/v1/data-lines")
public class DataGroupLineSiteController extends BaseController {
    ...
    public ResponseEntity<Page<DataGroupLine>> list(@PathVariable("dataGroupId") @Encrypt Long dataGroupId,
    ...
    public ResponseEntity<List<DataGroupLine>> create(@PathVariable("dataGroupId") @Encrypt Long dataGroupId,
    ...
    public ResponseEntity<?> remove(@PathVariable("dataGroupId") @Encrypt Long dataGroupId,
