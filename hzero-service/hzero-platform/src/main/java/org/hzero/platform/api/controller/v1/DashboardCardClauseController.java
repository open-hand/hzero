 ...
 */
@Api(tags = PlatformSwaggerApiConfig.DASHBOARD_CARD_CLAUSE)
@RestController("dashboardCardClauseController.v1")
@RequestMapping("/v1/{organizationId}/dashboard-card-clauses")
public class DashboardCardClauseController extends BaseController {
