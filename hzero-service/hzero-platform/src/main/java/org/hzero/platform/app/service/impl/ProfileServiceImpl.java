...
public class ProfileServiceImpl implements ProfileService {
    ...
    public Profile insertOrUpdate(Profile profile) {
        profile.validate();
        processEscape(profile);
        return profileDomainService.insertOrUpdate(profile);
    }

    private void processEscape(Profile profile) {
        profile.setProfileName(EscapeUtils.escape(profile.getProfileName()));
        profile.setDescription(EscapeUtils.escape(profile.getDescription()));
    }
