 ...
 */
@Api(tags = PlatformSwaggerApiConfig.PROMPT)
@RestController("promptController.v1")
...
public class PromptController extends BaseController {
    ...
    public ResponseEntity getDescriptionByTenantId(@PathVariable Long organizationId,
