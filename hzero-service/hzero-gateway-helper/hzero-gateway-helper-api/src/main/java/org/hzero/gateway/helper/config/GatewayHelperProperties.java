...
public class GatewayHelperProperties {
    ...
    private String jwtKey = "openhand";
    ...
    public static class Permission {
        ...
        private static final List<String> DEFAULT_INTERNAL_PATHS = Arrays.asList(
                "/oauth/admin/**", "/oauth/api/**", "/oauth/v2/market/**", "/oauth/v1/**",
                "/v2/choerodon/api-docs", "/oauth/v2/choerodon/api-docs");
        ...
        public List<String> getInternalPaths() {
            // 保证这些默认的路径一直都在
            Set<String> allInternalPaths = new HashSet<>(DEFAULT_INTERNAL_PATHS);
            // 加入新配置的路径
            allInternalPaths.addAll(internalPaths);
            return new ArrayList<>(allInternalPaths);
        }
