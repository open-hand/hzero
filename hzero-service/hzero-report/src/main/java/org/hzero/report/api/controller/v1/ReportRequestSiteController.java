 ...
 */
@Api(tags = ReportSwaggerApiConfig.REPORT_REQUEST_SITE)
@RestController("reportRequestSiteController.v1")
@RequestMapping("/v1/report-requests")
public class ReportRequestSiteController extends BaseController {

    private final ReportRequestRepository reportRequestRepository;

    @Autowired
    public ReportRequestSiteController(ReportRequestRepository reportRequestRepository) {
    ...
    @GetMapping
    public ResponseEntity<Page<ReportRequest>> list(ReportRequest reportRequest,
    ...
    public ResponseEntity<Page<ReportRequest>> reportRequest(ReportRequest reportRequest,
                                                             @ApiIgnore @SortDefault(value = ReportRequest.FIELD_REQUEST_ID, direction = Sort.Direction.DESC) PageRequest pageRequest) {
