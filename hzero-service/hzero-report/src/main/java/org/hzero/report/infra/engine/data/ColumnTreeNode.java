 ...
 * 报表树型列节点类
 *
 * @author xianzhi.chen@hand-china.com 2018年10月17日下午4:23:35
 */
public class ColumnTreeNode {
    ...
    public boolean equals(Object o) {
        ...
        ColumnTreeNode that = (ColumnTreeNode) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(name, text, children, value, parent, width, depth, spans, path, column);
    }
}
