...
public class FileConfig {
     ...
     * 是否仅能删除自己上传的文件
     */
    private Boolean delCheckSelf = false;
    /**
     * 是否仅能删除自己上传的文件
     */
    private Boolean updateCheckSelf = true;
    ...
    public Boolean getDelCheckSelf() {
        return delCheckSelf;
    }

    public FileConfig setDelCheckSelf(Boolean delCheckSelf) {
        this.delCheckSelf = delCheckSelf;
        return this;
    }

    public Boolean getUpdateCheckSelf() {
        return updateCheckSelf;
    }

    public FileConfig setUpdateCheckSelf(Boolean updateCheckSelf) {
        this.updateCheckSelf = updateCheckSelf;
        return this;
    }
