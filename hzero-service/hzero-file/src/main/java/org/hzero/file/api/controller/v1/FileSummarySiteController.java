 ...
 */
@Api(tags = FileSwaggerApiConfig.FILE_SUMMARY_LIST_SITE)
@RestController("fileSummarySiteController.v1")
@RequestMapping("/v1/files/summary")
public class FileSummarySiteController extends BaseController {
    private final FileRepository fileRepository;

    @Autowired
    public FileSummarySiteController(FileRepository fileRepository) {
    ...
    @GetMapping
    @CustomPageRequest
    public ResponseEntity<Page<File>> pageFileList(FileParamsDTO fileParamsDTO,
