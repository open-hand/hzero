...
import { tableDS } from '@/stores/DirectiveIssuedLogDS';
import Drawer from './Drawer';

const DirectiveIssuedLog = ({ match: { path } }) => {
  ...
  return (
    <>
      <Header
        title={intl
          .get('hiot.directiveIssued.view.message.DirectiveIssuedLog')
          .d('指令下发日志监控')}
      />
      <Content>
...
export default formatterCollections({ code: ['hiot.directiveIssued', 'hiot.common'] })(
  DirectiveIssuedLog
);
