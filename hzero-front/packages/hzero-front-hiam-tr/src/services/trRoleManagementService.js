...
function clientDel() {
  return isTenantRoleLevel()
    ? `${tenantId}/tr-member-roles/batch-assign`
    : 'tr-member-roles/batch-assign';
}
...
export async function enableRole(params) {
  ...
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/${tenantId}/tr-roles/${enableStatus(status)}`
      : `${HZERO_IAM}/v1/tr-roles/${enableStatus(status)}`,
    {
      method: 'PUT',
      body: others,
    }
...
export async function createRole(params) {
  return request(`${HZERO_IAM}/v1/tr-roles/create`, {
    method: 'POST',
    body: params,
  });
}
...
export async function createOrganizationRole(params, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-roles/create`, {
    method: 'POST',
    body: params,
  });
}
...
export async function copyRole(params) {
  return request(`${HZERO_IAM}/v1/tr-roles/copy`, {
    method: 'POST',
    body: params,
  });
}
...
export async function copyOrganizationRole(params, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-roles/copy`, {
    method: 'POST',
    body: params,
  });
}
...
export async function inheritRole(params) {
  return request(`${HZERO_IAM}/v1/tr-roles/inherit`, {
    method: 'POST',
    body: params,
  });
}
...
export async function inheritOrganizationRole(params, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-roles/inherit`, {
    method: 'POST',
    body: params,
  });
}
...
export async function saveMembers(data, isEdit) {
  return request(`${HZERO_IAM}/v1/tr-member-roles/batch-assign`, {
    method: 'POST',
    body: data,
    query: {
      isEdit,
...
export async function saveOrganizationMembers(data, isEdit, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-member-roles/batch-assign`, {
    method: 'POST',
    body: data,
    query: {
      isEdit,
...
export async function deleteMember(data = {}) {
  return request(`${HZERO_IAM}/v1/tr-member-roles/batch-delete`, {
    method: 'DELETE',
    body: data,
  });
}
...
export async function deleteOrganizationMember(data = {}, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-member-roles/batch-delete`, {
    method: 'DELETE',
    body: data,
  });
}
...
export async function saveClients(data) {
  return request(`${HZERO_IAM}/v1/${clientAdd}`, {
    method: 'POST',
    body: data,
  });
}
...
export async function queryPermissionMenus(roleId, params) {
  return request(
    organizationRoleLevel
      ? `${HZERO_IAM}/v1/${tenantId}/tr-roles/${roleId}/permission-sets/tree`
      : `${HZERO_IAM}/v1/tr-roles/${roleId}/permission-sets/tree`,
    {
      query: params,
    }
  );
...
export async function batchAssignPermissionSets(roleId, data) {
  return request(`${HZERO_IAM}/v1/tr-roles/${roleId}/permission-sets/assign`, {
    method: 'POST',
    body: data,
  });
}
...
export async function batchAssignOrganizationPermissionSets(roleId, data, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-roles/${roleId}/permission-sets/assign`, {
    method: 'POST',
    body: data,
  });
}
...
export async function batchUnassignPermissionSets(roleId, data) {
  return request(`${HZERO_IAM}/v1/tr-roles/${roleId}/permission-sets/recycle`, {
    method: 'POST',
    body: data,
  });
}
...
export async function batchUnassignOrganizationPermissionSets(roleId, data, organizationId) {
  return request(`${HZERO_IAM}/v1/${organizationId}/tr-roles/${roleId}/permission-sets/recycle`, {
    method: 'POST',
    body: data,
  });
}
...
export async function queryCreatedSubroles(params = {}) {
  ...
  return request(
    isTenantRoleLevel() ? `${HZERO_IAM}/v1/${tenantId}/tr-roles` : `${HZERO_IAM}/v1/tr-roles`,
    {
      query,
    }
  );
...
export async function fetchParentRole() {
  return request(`${HZERO_IAM}/v1/${tenantId}/tr-roles/admin-role`, {
    method: 'GET',
  });
}

export async function fetchSiteParentRole() {
  return request(`${HZERO_IAM}/v1/tr-roles/admin-role`, {
    method: 'GET',
  });
}
