 ...
 */
export async function subAccountOrgRoleQueryAll(params) {
  const { userId, ...others } = params;
  return request(
    `${HZERO_IAM}/v1/${currentOrganizationId}/tr-member-roles/user-assignable-roles/${userId}`,
    {
      method: 'GET',
      query: others,
    }
...
export async function subAccountOrgCreateOne(params = {}) {
  ...
  return request(`${HZERO_IAM}/v1/${currentOrganizationId}/tr-users`, {
    body: userInfo,
    method: 'POST',
    query: others,
  });
...
export async function deleteRoles(memberRoleList) {
  return request(`${HZERO_IAM}/v1/${currentOrganizationId}/tr-member-roles/batch-delete`, {
    method: 'DELETE',
    body: memberRoleList,
  });
}
...
export async function fetchChangeEnabled(params) {
  ...
  return request(
    enabled === false
      ? `${HZERO_IAM}/v1/${currentOrganizationId}/tr-users/unfrozen`
      : `${HZERO_IAM}/v1/${currentOrganizationId}/tr-users/frozen`,
    {
      method: 'POST',
      body: params,
    }
...
export async function saveRole(params) {
  return request(`${HZERO_IAM}/v1/${currentOrganizationId}/tr-member-roles/batch-assign`, {
    method: 'POST',
    body: params,
  });
}
