...
export default class EditFormModal extends Component {
  ...
  render() {
    ...
    const title = isCreate
      ? intl.get('hiam.subAccount.view.title.fieldPermissionCreate').d('字段权限新建')
      : intl.get('hiam.subAccount.view.title.fieldPermissionEdit').d('字段权限编辑');
    return (
      <Modal
        destroyOnClose
        title={title}
        ...
        <Form>
          <Row>
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('hiam.subAccount.model.fieldPermission.fieldName')
                          .d('字段名称'),
                      }),
                    },
                  ],
            ...
            <Col>
              <Form.Item
                {...MODAL_FORM_ITEM_LAYOUT}
                label={intl.get('hiam.subAccount.model.fieldPermission.fieldType').d('字段类型')}
              >
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('hiam.subAccount.model.fieldPermission.fieldType')
                          .d('字段类型'),
                      }),
                    },
                  ],
                  ...
                  rules: [
                    {
                      required: true,
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl.get('hiam.subAccount.model.fieldPermission.rule').d('权限规则'),
                      }),
                    },
                  ],
                })(
            ...
            {form.getFieldValue('permissionType') === 'DESENSITIZE' && (
              <Col>
                <Form.Item
                  {...MODAL_FORM_ITEM_LAYOUT}
                  label={intl
                    .get('hiam.subAccount.model.fieldPermission.desensitize')
                    .d('脱敏规则')}
                >
