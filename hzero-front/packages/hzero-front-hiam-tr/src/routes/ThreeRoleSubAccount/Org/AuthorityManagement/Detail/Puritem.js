 ...
 * @reactProps {Object} trAuthorityCustomer - 数据源
...
@connect(({ trAuthorityCustomer, loading }) => ({
  trAuthorityCustomer,
  loading: loading.models.trAuthorityCustomer,
}))
export default class Customer extends React.Component {
  ...
  addData() {
    ...
    dispatch({
      type: 'trAuthorityCustomer/addNewData',
      payload: data,
    });
  }
  ...
  cancel(record) {
    ...
    if (record.isCreate) {
      ...
      dispatch({
        type: 'trAuthorityCustomer/removeNewAdd',
        payload: {},
      });
    } else {
  ...
  remove() {
    ...
    const onOk = () => {
      ...
      if (deleteRows.length > 0) {
        dispatch({
          type: 'trAuthorityCustomer/delete',
          payload: {
            userId,
            deleteRows,
          },
  ...
  refresh() {
    ...
    dispatch({
      type: 'trAuthorityCustomer/fetch',
      payload: staticData,
    });
  }
      ...
      <div>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ display: 'inline-block', margin: '0 8px 16px 0' }}>
            ...
            <Tooltip
              title={intl
                .get('hiam.authority.view.message.title.tooltip')
