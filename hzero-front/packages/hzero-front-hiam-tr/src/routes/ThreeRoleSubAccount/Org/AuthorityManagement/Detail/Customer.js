...
@connect(({ trAuthorityCustomer, loading }) => ({
  ...
  addLoading: loading.effects['trAuthorityCustomer/addAuthorityCustomer'],
  fetchLoading: loading.effects['trAuthorityCustomer/fetchAuthorityCustomer'],
}))
...
export default class Customer extends React.Component {
  ...
  fetchData(pageData) {
    ...
    form.validateFields((err, fieldsValue) => {
      if (!err) {
        dispatch({
          type: 'trAuthorityCustomer/fetchAuthorityCustomer',
          payload: {
            ...fieldsValue,
            ...staticData,
            ...pageData,
  ...
  addCompany(addRows) {
    ...
    dispatch({
      type: 'trAuthorityCustomer/addAuthorityCustomer',
      payload: {
        authorityTypeCode: 'CUSTOMER',
        userId,
        userAuthority: head,
  ...
  remove() {
    ...
    const onOk = () => {
      dispatch({
        type: 'trAuthorityCustomer/deleteAuthorityCustomer',
        payload: {
          userId,
  ...
  render() {
    const {
      trAuthorityCustomer: { list = [], head = {}, pagination },
      userId,
      organizationId,
      addLoading,
      fetchLoading,
