 ...
 * @reactProps {Object} trAuthorityPurcat - 数据源
...
@connect(({ trAuthorityPurcat, loading }) => ({
  trAuthorityPurcat,
  organizationId: getCurrentOrganizationId(),
  addLoading: loading.effects['trAuthorityPurcat/addAuthorityPurcat'],
  fetchLoading: loading.effects['trAuthorityPurcat/fetchAuthorityPurcat'],
}))
export default class Purcat extends React.Component {
  ...
  fetchData(pageData = {}) {
    ...
    form.validateFields((err, fieldsValue) => {
      if (!err) {
        dispatch({
          type: 'trAuthorityPurcat/fetchAuthorityPurcat',
          payload: {
            ...fieldsValue,
            ...staticData,
            ...pageData,
  ...
  addPurcat(addRows) {
    const {
      dispatch,
      trAuthorityPurcat: { head = {} },
      userId,
    } = this.props;
    dispatch({
      type: 'trAuthorityPurcat/addAuthorityPurcat',
      payload: {
        authorityTypeCode: 'PURCAT',
        userId,
        userAuthority: head,
  ...
  remove() {
    ...
    const onOk = () => {
      dispatch({
        type: 'trAuthorityPurcat/deleteAuthorityPurcat',
        payload: {
          userId,
  ...
  render() {
    const {
      trAuthorityPurcat: { list = [], head = {}, pagination = {} },
      userId,
      organizationId,
      addLoading,
      fetchLoading,
