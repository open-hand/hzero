 ...
 * @reactProps {Object} trAuthorityManagement，trAuthorityCompany，trAuthoritySupplier，trAuthorityPurorg，trAuthorityPurcat，trAuthorityCustomer - 数据源
...
@connect(
  ({
    trAuthorityDimension,
    trAuthorityCompany,
    trAuthorityCustomer,
    trAuthoritySupplier,
    trAuthorityPurorg,
    trAuthorityPurcat,
    trAuthorityManagement,
    trAuthorityValueList,
    trAuthorityLovView,
    trAuthorityDataSource,
    trAuthorityDataGroup,
    loading,
  }) => ({
    trAuthorityDimension,
    trAuthorityCompany,
    ...
    trAuthorityDataSource,
    trAuthorityDataGroup,
    fetchTabListLoading: loading.effects['trAuthorityManagement/fetchUserDimension'],
  })
)
@withRouter
export default class AuthorityManagement extends React.Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'trAuthorityManagement/fetchUserInfo',
      payload: { userId },
    });
    dispatch({
      type: 'trAuthorityManagement/fetchUserDimension',
      payload: { userId },
    }).then((res) => {
  ...
  componentWillUnmount() {
    ...
    dispatch({
      type: 'trAuthorityManagement/updateState',
      payload: { authorList: [] },
    });
    dispatch({
      type: 'trAuthorityCompany/updateState',
      payload: {
        data: [],
        checkList: [],
        originList: [],
    ...
    dispatch({
      type: 'trAuthorityPuragent/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
    ...
    dispatch({
      type: 'trAuthorityPurorg/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
  ...
  fetchData(name) {
    ...
    dispatch({
      type: `trAuthority${lodash.upperFirst(name)}/fetchAuthority${lodash.upperFirst(name)}`,
      payload: staticData,
    });
    if (name === 'lov') {
      dispatch({
        type: `trAuthorityValueList/fetchAuthorityValueList`,
        payload: staticData,
      });
    }
  }
  ...
  changeAuthority(values, form) {
    ...
    const { userId } = this.state;
    dispatch({
      type: 'trAuthorityManagement/changeAuthority',
      payload: {
        userId,
  ...
  render() {
    const {
      trAuthorityManagement: { data = {} },
      trAuthorityManagement: { authorList = [] },
        ...
        <Header
          ...
          backPath={
            path.indexOf('/private') === 0
              ? `/private/hiam/tr-account/org/users?access_token=${accessToken}`
              : '/hiam/tr-account/org/users'
          }
        >
          <>
            <ButtonPermission
