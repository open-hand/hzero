...
@connect(
  ({
    trSecGrpAuthorityValueList,
    trSecGrpAuthorityPurorg,
    trSecGrpAuthorityPuragent,
    trSecGrpAuthorityLovView,
    trSecGrpAuthorityDataSource,
    trSecGrpAuthorityDataGroup,
    trSecGrpAuthorityCompany,
    loading,
  }) => ({
    trSecGrpAuthorityCompany,
    trSecGrpAuthorityValueList,
    fetchValueListLoading: loading.effects['trSecGrpAuthorityValueList/fetchAuthorityValueList'],
    trSecGrpAuthorityPurorg,
    fetchPurorgLoading: loading.effects['trSecGrpAuthorityPurorg/fetchAuthorityPurorg'],
    trSecGrpAuthorityPuragent,
    fetchPuragentLoading: loading.effects['trSecGrpAuthorityPuragent/fetchAuthorityPuragent'],
    trSecGrpAuthorityLovView,
    fetchLovViewLoading: loading.effects['trSecGrpAuthorityLovView/fetchAuthorityLovView'],
    trSecGrpAuthorityDataSource,
    fetchDataSourceLoading: loading.effects['trSecGrpAuthorityDataSource/fetchAuthorityDataSource'],
    trSecGrpAuthorityDataGroup,
    fetchDataGroupLoading: loading.effects['trSecGrpAuthorityDataGroup/fetchAuthorityDataGroup'],
  })
)
export default class DataPermissionTab extends React.Component {
  ...
  componentWillUnmount() {
    ...
    dispatch({
      type: 'trSecGrpAuthorityCompany/updateState',
      payload: {
        data: [],
        checkList: [],
        originList: [],
    ...
    dispatch({
      type: 'trSecGrpAuthorityPuragent/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
    ...
    dispatch({
      type: 'trSecGrpAuthorityPurorg/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
    ...
    dispatch({
      type: 'trSecGrpAuthorityDataSource/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
    ...
    dispatch({
      type: 'trSecGrpAuthorityDataGroup/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
    ...
    dispatch({
      type: 'trSecGrpAuthorityValueList/updateState',
      payload: {
        head: {}, // 头部数据
        list: [], // 请求查询到的数据
        pagination: {}, // 分页信息
