...
@connect(({ trSecGrpAuthorityCompany, loading }) => ({
  trSecGrpAuthorityCompany,
  fetchLoading: loading.effects['trSecGrpAuthorityCompany/fetchAuthorityCompanyAndExpand'],
}))
...
export default class Company extends PureComponent {
  ...
  queryValue() {
    ...
    form.validateFields((err, fieldsValue) => {
      if (!err) {
        ...
        dispatch({
          type: 'trSecGrpAuthorityCompany/fetchAuthorityCompanyAndExpand',
          payload: {
            ...fieldsValue,
            secGrpId,
            roleId,
  ...
  onExpand(expanded, record = {}) {
    const {
      dispatch,
      trSecGrpAuthorityCompany: { expandedRowKeys = [] },
    } = this.props;
    dispatch({
      type: 'trSecGrpAuthorityCompany/updateExpanded',
      payload: expanded
  ...
  handleExpand() {
    const {
      dispatch,
      trSecGrpAuthorityCompany: { originList = [] },
    } = this.props;
  ...
  render() {
    const {
      ...
      shieldLoading = false,
      path,
      trSecGrpAuthorityCompany: { data = [], checkList = [], expandedRowKeys = [] } = {},
    } = this.props;
    const columns = [
      {
        title: intl
