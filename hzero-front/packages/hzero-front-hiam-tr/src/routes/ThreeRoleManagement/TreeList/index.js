...
@connect(
  ({
    ...
    fetchTreeListLoading:
      loading.effects['trRoleManagement/queryRoleRoot'] ||
      loading.effects['trRoleManagement/queryRoleChildren'] ||
      loading.effects['trRoleManagement/queryRoleAll'],
    fetchRoleChildrenLoading: loading.effects['trRoleManagement/queryRoleChildren'],
  })
)
...
export default class RoleManagement extends React.Component {
   ...
   */
  componentDidMount() {
    const { trRoleManagement = {}, location = {}, dispatch } = this.props;
    const { code, list = {} } = trRoleManagement;
  ...
  fetchRoleRoot(params) {
    ...
    this.setState(
      ...
      () => {
        dispatch({
          type: 'trRoleManagement/queryRoleRoot',
          payload: params,
        });
      }
    );
  ...
  fetchRoleAll(params) {
    ...
    if (isEmpty(fieldValues)) {
      ...
      const { dispatch } = this.props;
      dispatch({
        type: 'trRoleManagement/queryRoleAll',
        payload: params,
      });
    }
  }
  ...
  fetchRoleChildren(params = {}) {
    const { dispatch } = this.props;
    dispatch({
      type: 'trRoleManagement/queryRoleChildren',
      payload: params,
    });
  }
  ...
  fetchList(params) {
    const { dispatch } = this.props;
    dispatch({ type: 'trRoleManagement/queryList', params }).then(() => {
