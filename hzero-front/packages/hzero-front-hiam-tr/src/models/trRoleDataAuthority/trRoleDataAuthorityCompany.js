/**
 * roleDataAuthorityCompany - 租户级权限维护tab页 - 公司 - model
 * @date: 2018-7-31
...
import { queryCompany, updateCompany } from '../../services/trRoleDataAuthorityService';

export default {
  namespace: 'trRoleDataAuthorityCompany',
