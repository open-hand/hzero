...
function AuthorityTab(props) {
    ...
    form.validateFields((err, fieldsValue) => {
      if (!err) {
        ...
        if (isSecGrp) {
          if (!isAccount) {
            dispatch({
              type: `trAuthorityDimension/querySecGrpAuthorityData`,
              payload,
            }).then((res) => {
              if (res) {
                setList(res.content);
            ...
            dispatch({
              type: `trAuthorityDimension/queryAccountSecGrpAuthorityData`,
              payload,
            }).then((res) => {
              if (res) {
                setList(res.content);
          ...
          dispatch({
            type: `trAuthorityDimension/query${
  ...
  const remove = () => {
    const onOk = () => {
      dispatch({
        type: `trAuthorityDimension/delete${
          !lodash.isUndefined(queryParams.userId) ? `User` : `Role`
        }AuthorityData`,
        payload: {
          ...queryParams,
...
function mapStateToProps({ trAuthorityDimension, loading }) {
  return {
    trAuthorityDimension,
    addLoading:
      loading.effects[`trAuthorityDimension/addUserAuthorityData`] ||
      loading.effects[`trAuthorityDimension/addRoleAuthorityData`],
    fetchLoading:
      loading.effects[`trAuthorityDimension/queryUserAuthorityData`] ||
      loading.effects[`trAuthorityDimension/queryRoleAuthorityData`] ||
      loading.effects[`trAuthorityDimension/querySecGrpAuthorityData`] ||
      loading.effects[`trAuthorityDimension/queryAccountSecGrpAuthorityData`],
  };
}
