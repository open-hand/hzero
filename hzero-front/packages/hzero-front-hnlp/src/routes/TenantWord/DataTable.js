  ...
  getColumns() {
    ...
    return [
      isSiteFlag && {
        ...
        width: 200,
        title: languageMessage.model.tenantWord.tenant,
      },
      {
        dataIndex: 'actualWord',
        title: languageMessage.model.tenantWord.actualWord,
        width: 200,
      },
      {
        dataIndex: 'word',
        title: languageMessage.model.tenantWord.word,
      },
      {
        key: 'action',
