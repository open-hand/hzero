...
import { Tabs, Row, Col, Input, List } from 'choerodon-ui';
...
const { TabPane } = Tabs;
@formatterCollections({ code: ['hfnt.common'] })
class Cron extends PureComponent {
  ...
  renderOverLay() {
    ...
    return (
      ...
      >
        <TabPane tab={COMMON_LANG.SECOND} key="second">
          <Second
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.MINUTE} key="minute">
          <Minute
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.HOUR} key="hour">
          <Hour
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.DAY} key="day">
          <Day
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.MONTH} key="month">
          <Month
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.WEEK} key="week">
          <Week
            {...this.state}
            onChange={(state) => {
        ...
        <TabPane tab={COMMON_LANG.YEAR} key="year">
          <Year
            {...this.state}
            onChange={(state) => {
        ...
        <List bordered style={{ marginTop: 10 }}>
          <List.Item>
            <Row type="flex" gutter={5} style={{ width: '100%', textAlign: 'center' }}>
              <Col span={3}>{COMMON_LANG.SECOND}</Col>
              <Col span={3}>{COMMON_LANG.MINUTE}</Col>
              <Col span={3}>{COMMON_LANG.HOUR}</Col>
              <Col span={3}>{COMMON_LANG.DAY}</Col>
              <Col span={3}>{COMMON_LANG.MONTH}</Col>
              <Col span={3}>{COMMON_LANG.WEEK}</Col>
              <Col span={3}>{COMMON_LANG.YEAR}</Col>
            </Row>
          </List.Item>
          <List.Item>
            <Row type="flex" gutter={5} style={{ width: '100%', textAlign: 'center' }}>
