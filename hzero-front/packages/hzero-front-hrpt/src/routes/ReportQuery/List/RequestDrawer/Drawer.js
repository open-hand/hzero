...
export default class JobGroupForm extends React.Component {
  @Bind()
  handleExport() {
    ...
    return (
      ...
      >
        <Spin spinning={fetchRequestDetailLoading}>
          <Form.Item
            label={intl.get('hrpt.reportQuery.model.reportQuery.requester').d('请求人名称')}
            {...formLayout}
          >
          ...
          <FormItem
            label={intl.get('hrpt.reportQuery.model.reportQuery.requestParam').d('请求参数')}
            {...formLayout}
          >
          ...
          <Form.Item label={intl.get('hrpt.common.view.startTime').d('开始时间')} {...formLayout}>
          ...
          <FormItem
            label={intl.get('hrpt.reportQuery.model.reportQuery.requestMessage').d('请求消息')}
            {...formLayout}
          >
