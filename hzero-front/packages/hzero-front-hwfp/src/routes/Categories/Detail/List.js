...
export default class List extends Component {
   ...
   */
  render() {
    const { loading, predefined, onFetchVariables, dataSource = [] } = this.props;
    const columns = [
      {
        title: intl.get('hwfp.categories.model.categories.variableName').d('字段名称'),
      ...
      {
        title: intl.get('hwfp.common.model.categories.description').d('字段描述'),
        dataIndex: 'description',
      },
      {
        title: intl.get('hwfp.common.model.categories.operator').d('是否必输'),
