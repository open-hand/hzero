...
function validateRule (item, path, itemId, meta, c) {
  ...
  const {newValue, newValueSrc, newValueError} = getNewValueForFieldOp(config, oldConfig, properties, field, operator, null, true);
  value = newValue;
...
export const getNewValueForFieldOp = function (config, oldConfig = null, current, newField, newOperator, changedField = null, canFix = true) {
  ...
  let newValue = null; let newValueSrc = null; let newValueType = null; let newValueError = null;
