    ...
    return (
      ...
      >
        <Form>
          ...
          <Form.Item
            label={intl.get('hsdr.concurrent.model.concurrent.roleId').d('角色')}
            {...formLayout}
          >
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hsdr.concurrent.model.concurrent.roleId').d('角色'),
                  }),
                },
              ],
            })(
          ...
          <Form.Item
            label={intl.get('hsdr.concurrent.model.concurrent.startDate').d('有效期从')}
            {...formLayout}
          >
          ...
          <Form.Item
            label={intl.get('hsdr.concurrent.model.concurrent.endDate').d('有效期至')}
            {...formLayout}
          >
