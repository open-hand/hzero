/**
 * AddDataModal - 创建数据组行/创建分配值弹窗
 * @author: lingfangzi.hu01@hand-china.com
 * @version: 0.0.1
 * @copyright Copyright (c) 2018, Hand
 */
import React from 'react';
import { Form, Input, Modal, Table, Button, notification } from 'hzero-ui';
...
export default class EditForm extends React.Component {
  ...
  okHandle() {
    ...
    if (addRows.length) {
      ...
      notification.warning({message: intl.get('hzero.common.validation.atLeast').d('请至少选择一条数据')});
    }
  }
