...
export default class DetailForm extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Form>
          <Form.Item {...MODAL_FORM_ITEM_LAYOUT} label={intl.get('hpfm.dimensionConfig.model.line.value').d('维度值')}>
            {getFieldDecorator('value', {
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hpfm.dimensionConfig.model.line.value').d('维度值'),
                  }),
                },
              ],
              initialValue: value,
          ...
          <Form.Item
            {...MODAL_FORM_ITEM_LAYOUT}
            label={intl.get('hpfm.dimensionConfig.model.line.meaning').d('维度值含义')}
          >
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hpfm.dimensionConfig.model.line.meaning').d('维度值含义'),
                  }),
                },
              ],
          ...
          <Form.Item
            {...MODAL_FORM_ITEM_LAYOUT}
            label={intl.get('hpfm.dimensionConfig.model.line.parentValue').d('父级维度值')}
          >
          ...
          <Form.Item {...MODAL_FORM_ITEM_LAYOUT} label={intl.get('hpfm.valueList.model.line.tag').d('标记')}>
