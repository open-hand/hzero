...
databaseChangeLog(logicalFilePath: 'script/db/hmsg_webhook_server_tl.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-09-01-hmsg_webhook_server_tl") {
        def weight = 1
        ...
        if (helper.dbType().isSupportSequence()) {
            createSequence(sequenceName: "hmsg_webhook_server_tl_s", startValue: "1")
        }
        createTable(tableName: "hmsg_webhook_server_tl", remarks: "") {
            column(name: "server_id", type: "bigint", remarks: "hmsg_webhook_server表ID") {
